...
type (
	profilePictureModel interface {
		Insert(ctx context.Context, data *ProfilePicture) (int64, error)                // 返回的是受影响行数，如需获取自增id，请通过data参数获取
		TxInsert(ctx context.Context, tx *gorm.DB, data *ProfilePicture) (int64, error) // 用于事务新增数据，由上层(如rpc层)调用Transaction去实现，返回受影响的行数

		FindOne(ctx context.Context, id int64) (*ProfilePicture, error)                                                 // 通过主键id查找数据
		Finds(ctx context.Context, queries []Query, orders []Order) ([]*ProfilePicture, error)                          // 按条件查询，不分页
		FindsByPage(ctx context.Context, queries []Query, page *Page, orders []Order) ([]*ProfilePicture, int64, error) // 分页查询
		FindCount(ctx context.Context, queries []Query) (int64, error)

		FindOneByMd5(ctx context.Context, md5 string) (*ProfilePicture, error) // 通过指定字段查找数据

		Update(ctx context.Context, id int64, data *ProfilePicture) (int64, error)                                 // 通过主键id更新指定字段，零值不可更新，返回受影响行数
		TxUpdate(ctx context.Context, tx *gorm.DB, id int64, data *ProfilePicture) (int64, error)                  // 用于事务更新数据，由上层(如rpc层)调用Transaction去实现，零值不可更新，返回受影响行数
	...
	defaultProfilePictureModel struct {
		DB *gorm.DB
	}
...
func newProfilePictureModel(conn *gorm.DB) *defaultProfilePictureModel {
	return &defaultProfilePictureModel{
		DB: conn,
	}
}

// Insert 返回的是受影响行数，如需获取自增id，请通过data参数获取
func (d *defaultProfilePictureModel) Insert(ctx context.Context, data *ProfilePicture) (int64, error) {
...
// tx：上层传递时请加上context
func (d *defaultProfilePictureModel) TxInsert(ctx context.Context, tx *gorm.DB, data *ProfilePicture) (int64, error) {
...
func (d *defaultProfilePictureModel) Update(ctx context.Context, id int64, data *ProfilePicture) (int64, error) {
...
func (d *defaultProfilePictureModel) TxUpdate(ctx context.Context, tx *gorm.DB, id int64, data *ProfilePicture) (int64, error) {
...
func (d *defaultProfilePictureModel) UpdateOneMapById(ctx context.Context, id int64, data map[string]interface{}) (int64, error) {
	...
	result := d.DB.Debug().WithContext(ctx).Model(&ProfilePicture{}).Where("`id` = ?", id).Updates(data)
	if result.Error != nil {
...
// tx：上层传递时请加上context
func (d *defaultProfilePictureModel) TxUpdateOneMapById(ctx context.Context, tx *gorm.DB, id int64, data map[string]interface{}) (int64, error) {
	...
	result := tx.Debug().WithContext(ctx).Model(&ProfilePicture{}).Where("`id` = ?", id).Updates(data)
	if result.Error != nil {
...
func (d *defaultProfilePictureModel) Delete(ctx context.Context, id int64) (int64, error) {
	...
	result := d.DB.Debug().WithContext(ctx).Where("`id` = ?", id).Delete(&ProfilePicture{})
	if result.Error != nil {
...
func (d *defaultProfilePictureModel) TxDelete(ctx context.Context, tx *gorm.DB, id int64) (int64, error) {
	...
	result := tx.Debug().WithContext(ctx).Where("`id` = ?", id).Delete(&ProfilePicture{})
	if result.Error != nil {
...
func (d *defaultProfilePictureModel) Deletes(ctx context.Context, ids []int64) (int64, error) {
	...
	result := d.DB.Debug().WithContext(ctx).Where("`id` in ?", ids).Delete(&ProfilePicture{})
	if result.Error != nil {
...
func (d *defaultProfilePictureModel) TxDeletes(ctx context.Context, tx *gorm.DB, ids []int64) (int64, error) {
	...
	result := tx.Debug().WithContext(ctx).Where("`id` in ?", ids).Delete(&ProfilePicture{})
	if result.Error != nil {
...
// FindOne 通过主键id查找数据
func (d *defaultProfilePictureModel) FindOne(ctx context.Context, id int64) (*ProfilePicture, error) {
...
// queries: 查询条件集合;
// orders: 排序字符串
func (d *defaultProfilePictureModel) Finds(ctx context.Context, queries []Query, orders []Order) ([]*ProfilePicture, error) {
...
// page: 分页条件
// orders: 排序字符串
func (d *defaultProfilePictureModel) FindsByPage(ctx context.Context, queries []Query, page *Page, orders []Order) ([]*ProfilePicture, int64, error) {
	...
	err := db.Model(&ProfilePicture{}).Count(&count).Error
	if err != nil {
...
// FindCount 按条件查询记录条数
// queries: 查询条件集合;
func (d *defaultProfilePictureModel) FindCount(ctx context.Context, queries []Query) (int64, error) {
...
func (d *defaultProfilePictureModel) FindOneByMd5(ctx context.Context, md5 string) (*ProfilePicture, error) {
